...
<!--session测试发送到show.jpg-->
<%
String sessionMesssage = "刁玉宽，你好";
session.setAttribute("message",sessionMesssage);
%>
<form method="post" name="form1" action="show.jsp" onsubmit="checkNull(form1)" >
    <table id="table1">
        <tr>
        ...
        <tr>
            <td>用户名</td>
            <td><input type="text" name="user1" id="user" title="用户名" value="<%=info[0]%>"></td>
        </tr>

        <tr>
            <td>用户工号</td>
            <td><input type="text" name="user" id="number" title="用户工号" value="<%=info[1]%>"></td>
        </tr>

        <tr>
            <td>密&nbsp码</td>
            <td><input type="password" name="pwd" id="pwd1" title="密码" value="<%=info[2]%>"></td>
        </tr>

        <tr>
            <td>确认密码</td>
            <td><input type="password" name="pwd2" id="pwd2" title="确认密码" value="<%=info[3]%>"></td>
        </tr>
